...
**3. Get Category by ID**
```
GET /transactions/categories/{{category_id}}
```
✅ Get specific category details

**4. Update Category**
```
PUT /transactions/categories/{{category_id}}
...
```
GET /transactions/categories/{{category_id}}/statistics
```
✅ See how many transactions use this category

**6. Toggle Category**
```
PATCH /transactions/categories/{{category_id}}/toggle
```
✅ Activate/deactivate category

**7. Delete Category (if not default)**
```
...
- `{{base_url}}/transactions/categories/{{category_id}}`
- `{{base_url}}/transactions/categories/{{category_id}}/statistics`
...
|----------|--------|---------|
| `/transactions/categories` | POST | Create category |
| `/transactions/categories` | GET | List all categories |
| `/transactions/categories/:id` | GET | Get category |
| `/transactions/categories/:id` | PUT | Update category |
| `/transactions/categories/:id` | DELETE | Delete category |
| `/transactions/categories/:id/toggle` | PATCH | Toggle active status |
| `/transactions/categories/:id/statistics` | GET | Get statistics |
